...
void App::OnSetup() {
  ...
  areaTop.Tag("AreaTop");
  areaTop.Group("Area");
  areaTop.AddComponent<BoundingBoxComponent>(140, 230, 130, 105);

  Entity areaMid = registry->CreateEntity();
  areaMid.Tag("AreaMid");
  areaMid.Group("Area");
  areaMid.AddComponent<BoundingBoxComponent>(170, 358, 140, 7);

  Entity areaBottom = registry->CreateEntity();
  areaBottom.Tag("AreaBottom");
  areaBottom.Group("Area");
  areaBottom.AddComponent<BoundingBoxComponent>(170, 426, 140, 7);
}
